...
type Bind struct {
	...
	DeviceType DeviceType `protobuf:"varint,1,opt,name=deviceType,json=device_type,proto3,enum=protocol.v1.DeviceType" json:"deviceType,omitempty"` //设备类型
	DeviceID   string     `protobuf:"bytes,2,opt,name=deviceID,json=device_id,proto3" json:"deviceID,omitempty"`                                    //客户端ID
	LoginType  LoginType  `protobuf:"varint,3,opt,name=loginType,json=login_type,proto3,enum=protocol.v1.LoginType" json:"loginType,omitempty"`     //登录类型
	CurVersion int32      `protobuf:"varint,4,opt,name=curVersion,json=cur_version,proto3" json:"curVersion,omitempty"`                             //客户端当前协议版本
	Magic      string     `protobuf:"bytes,5,opt,name=magic,proto3" json:"magic,omitempty"`                                                         //版本魔法数
	KeepAlive  uint64     `protobuf:"varint,6,opt,name=keepAlive,json=keep_alive,proto3" json:"keepAlive,omitempty"`                                //心跳超时
	QueueSize  uint32     `protobuf:"varint,7,opt,name=queueSize,json=queue_size,proto3" json:"queueSize,omitempty"`                                //最大消息缓存池大小
}
...
type BindAck struct {
	...
	BindRet         bool           `protobuf:"varint,1,opt,name=bindRet,json=bind_ret,proto3" json:"bindRet,omitempty"`                         //响应码
	ServerTimeStamp uint64         `protobuf:"varint,2,opt,name=serverTimeStamp,json=server_timestamp,proto3" json:"serverTimeStamp,omitempty"` //服务器时间戳
...
type Auth struct {
	...
	RoleType RoleType `protobuf:"varint,1,opt,name=roleType,json=role_type,proto3,enum=protocol.v1.RoleType" json:"roleType,omitempty"` //角色类型
...
type AuthAck struct {
	...
	AuthRet bool           `protobuf:"varint,1,opt,name=authRet,json=auth_ret,proto3" json:"authRet,omitempty"` //响应码
	UserID  string         `protobuf:"bytes,2,opt,name=userID,json=user_id,proto3" json:"userID,omitempty"`     //用户ID
	Err     *errors.Status `protobuf:"bytes,3,opt,name=err,proto3" json:"err,omitempty"`                        //kratos通用错误
}
...
func (x *AuthAck) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
type Sync struct {
	...
	ID        uint32     `protobuf:"varint,1,opt,name=ID,json=id,proto3" json:"ID,omitempty"`                       //同步会话标识ID,单次连接会话中有效
	SessionID uint64     `protobuf:"varint,2,opt,name=sessionID,json=session_id,proto3" json:"sessionID,omitempty"` //服务端会话ID，客户端参考使用，可取任意一条消息获取消息收发端状态
...
type SyncAck struct {
	...
	ID uint32 `protobuf:"varint,1,opt,name=ID,json=id,proto3" json:"ID,omitempty"` //与syncID一一对应
}
...
type SubmitOption struct {
	...
	SessionUpdate bool `protobuf:"varint,7,opt,name=sessionUpdate,json=session_update,proto3" json:"sessionUpdate,omitempty"` //更新会话最后一条消息
	MarkRead      bool `protobuf:"varint,8,opt,name=markRead,json=mark_read,proto3" json:"markRead,omitempty"`                //是否需要阅读标记
	CheckFriend   bool `protobuf:"varint,9,opt,name=checkFriend,json=check_friend,proto3" json:"checkFriend,omitempty"`       //是否需要检查好友关系
}
...
type Submit struct {
	...
	ID            uint32        `protobuf:"varint,1,opt,name=ID,json=id,proto3" json:"ID,omitempty"`                                          //消息唯一标识
	...
	ToType        UserType      `protobuf:"varint,4,opt,name=toType,json=to_type,proto3,enum=protocol.v1.UserType" json:"toType,omitempty"`   //接受者类型
	MsgType       MsgType       `protobuf:"varint,5,opt,name=msgType,json=msg_type,proto3,enum=protocol.v1.MsgType" json:"msgType,omitempty"` //消息类型
	...
	AtAll         bool          `protobuf:"varint,8,opt,name=atAll,json=at_all,proto3" json:"atAll,omitempty"`                                //是否为@all，为true时，ats不再生效
	NotifyContent string        `protobuf:"bytes,9,opt,name=notifyContent,json=notify_content,proto3" json:"notifyContent,omitempty"`         //自定义通知正文
...
type SubmitAck struct {
	...
	SubmitRet bool           `protobuf:"varint,1,opt,name=submitRet,json=submit_ret,proto3" json:"submitRet,omitempty"` //响应标识
	ID        uint32         `protobuf:"varint,2,opt,name=ID,json=id,proto3" json:"ID,omitempty"`                       //消息唯一标识,一一对应Sumit中id字段, 1-65535，会话期间循环使用，并且在短时间有效时间内（如10分钟）服务端做去重使用
	...
	SessionID uint64         `protobuf:"varint,4,opt,name=sessionID,json=session_id,proto3" json:"sessionID,omitempty"` //服务端会话标识，客户端参考使用
...
type Deliver struct {
	...
	SessionID    uint64   `protobuf:"varint,2,opt,name=sessionID,json=session_id,proto3" json:"sessionID,omitempty"`                        //会话ID，客户端参考使用
	From         string   `protobuf:"bytes,3,opt,name=from,proto3" json:"from,omitempty"`                                                   //发送者
	FromType     UserType `protobuf:"varint,4,opt,name=fromType,json=from_type,proto3,enum=protocol.v1.UserType" json:"fromType,omitempty"` //发送者类型
	To           string   `protobuf:"bytes,5,opt,name=to,proto3" json:"to,omitempty"`                                                       //接收者
	ToType       UserType `protobuf:"varint,6,opt,name=toType,json=to_type,proto3,enum=protocol.v1.UserType" json:"toType,omitempty"`       //接收者类型
	MsgType      MsgType  `protobuf:"varint,7,opt,name=msgType,json=msg_type,proto3,enum=protocol.v1.MsgType" json:"msgType,omitempty"`     //消息类型
	Payload      []byte   `protobuf:"bytes,8,opt,name=payload,proto3" json:"payload,omitempty"`                                             //消息负载，内包含json类型的消息业务类型
	SendTime     uint64   `protobuf:"varint,9,opt,name=sendTime,json=send_time,proto3" json:"sendTime,omitempty"`                           //发送时间
	EditTime     uint64   `protobuf:"varint,10,opt,name=editTime,json=edit_time,proto3" json:"editTime,omitempty"`                          //编辑时间
	DeleteTime   uint64   `protobuf:"varint,11,opt,name=deleteTime,json=delete_time,proto3" json:"deleteTime,omitempty"`                    //删除时间戳
	LastReadtime uint64   `protobuf:"varint,12,opt,name=lastReadtime,json=last_read_time,proto3" json:"lastReadtime,omitempty"`             //最后阅读时间
}
...
type DeliverAck struct {
	...
	DeliverRet bool           `protobuf:"varint,1,opt,name=deliverRet,json=deliver_ret,proto3" json:"deliverRet,omitempty"` //响应结果标识
	SessionID  uint64         `protobuf:"varint,2,opt,name=sessionID,json=session_id,proto3" json:"sessionID,omitempty"`    //会话ID，客户端参考使用
...
type Action struct {
	...
	ID      uint32 `protobuf:"varint,1,opt,name=ID,json=id,proto3" json:"ID,omitempty"`  //同submit id释义
...
type ActionAck struct {
	...
	ActionRet bool           `protobuf:"varint,1,opt,name=actionRet,json=action_ret,proto3" json:"actionRet,omitempty"` //响应结果标识
	ID        uint32         `protobuf:"varint,2,opt,name=ID,json=id,proto3" json:"ID,omitempty"`                       //与Action结构，id字段一一对应
	...
	Err       *errors.Status `protobuf:"bytes,5,opt,name=err,proto3" json:"err,omitempty"`                              //kratos通用错误
}
...
var file_api_protocol_v1_message_proto_rawDesc = []byte{
	...
	0x89, 0x02, 0x0a, 0x04, 0x42, 0x69, 0x6e, 0x64, 0x12, 0x38, 0x0a, 0x0a, 0x64, 0x65, 0x76, 0x69,
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x12, 0x1b, 0x0a, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x44, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x12,
	0x35, 0x0a, 0x09, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01,
	...
	,
	...
	,
	...
	,
}
