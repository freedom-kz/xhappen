...
type SyncRequest struct {
	...
	UserID      string   `protobuf:"bytes,1,opt,name=userID,json=user_id,proto3" json:"userID,omitempty"`                 //接收用户ID
	DeviceID    string   `protobuf:"bytes,2,opt,name=deviceID,json=device_id,proto3" json:"deviceID,omitempty"`           //接收的客户端标志
	BindVersion uint64   `protobuf:"varint,3,opt,name=bindVersion,json=bind_version,proto3" json:"bindVersion,omitempty"` //连接时间戳，作为连接版本过滤重复登录同步数据
...
type BroadcastRequest struct {
	...
	OmitDeviceIDs []string    `protobuf:"bytes,1,rep,name=omitDeviceIDs,json=omit_device_ids,proto3" json:"omitDeviceIDs,omitempty"` //忽略设备ID
	OmitUserIDs   []string    `protobuf:"bytes,2,rep,name=omitUserIDs,json=omit_user_ids,proto3" json:"omitUserIDs,omitempty"`       //忽略设备ID
...
type DeliverRequest struct {
	...
	OmitDeviceIDs []string    `protobuf:"bytes,3,rep,name=omitDeviceIDs,json=omit_device_ids,proto3" json:"omitDeviceIDs,omitempty"` //忽略设备ID
...
type DisconnectForceRequest struct {
	...
	UserID     string        `protobuf:"bytes,1,opt,name=userID,json=user_id,proto3" json:"userID,omitempty"`                                          //用户ID
	DeviceID   string        `protobuf:"bytes,2,opt,name=deviceID,json=device_id,proto3" json:"deviceID,omitempty"`                                    //设备ID
	DeviceType v1.DeviceType `protobuf:"varint,3,opt,name=deviceType,json=device_type,proto3,enum=protocol.v1.DeviceType" json:"deviceType,omitempty"` //设备类型
}
...
var file_api_gateway_v1_service_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x03, 0x65, 0x72, 0x72, 0x22, 0x9e, 0x01, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72,
	...
	0x28, 0x09, 0x52, 0x09, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x12, 0x26, 0x0a,
	0x0d, 0x6f, 0x6d, 0x69, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x44, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x6f, 0x6d, 0x69, 0x74, 0x5f, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x73, 0x12, 0x2e, 0x0a, 0x07, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72,
	...
	0x6c, 0x69, 0x76, 0x65, 0x72, 0x22, 0x42, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72,
	...
	,
	...
	0x79, 0x0a, 0x0b, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x10,
	...
	0x72, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18,
	...
	0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x16, 0x44,
	0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18,
	...
	0x52, 0x09, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x12, 0x38, 0x0a, 0x0a, 0x64,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0x4a, 0x0a, 0x14, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x10, 0x0a,
	...
	,
}
